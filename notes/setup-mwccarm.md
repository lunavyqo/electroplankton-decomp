...
## Electroplankton note

This project uses the same mwccarm tree layout as sm64ds-decomp. Compiler pin
for matching is documented in [compiler.md](compiler.md) (currently
`1.2/sp2p3`, provisional). Place the zip under `tools/mwccarm/` the same way.
