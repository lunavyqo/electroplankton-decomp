...
|--------|-------------------|----------|------------|--------|-------|
| arm9   | mixed size-0x24/0x28 leaves (0x02001b6c…0x0204ee6c) | lunavyqo | 2026-07-19 | done | batch16: 16/16 MATCH destroy chains, dual-base, counter, tailcalls, find-slot (1.2/sp2p3) |
| arm9   | mixed size-0x24 leaves (0x0203d12c…0x0204c220) | lunavyqo | 2026-07-18 | done | batch16: 16/16 MATCH size-0x24 helpers (cache MCR, list, wrappers, flag set; 1.2/sp2p3) |
...
| arm9   | mixed tailcall leaves (0x02001cc8…0x02051434) | lunavyqo | 2026-07-18 | done | batch16: 16/16 MATCH tail wrappers + spins + stores (1.2/sp2p3) |
| arm9   | mixed 0x18 leaves (0x02027074…0x02050238) | lunavyqo | 2026-07-18 | done | batch16: 16/16 MATCH size-0x18 helpers (tail wrappers, fill/copy, spin-waits; 1.2/sp2p3) |
...
| arm9   | 0x020019d8–0x02001cc7 | lunavyqo | 2026-07-18 | done | batch16: 16/16 MATCH size-0x1c tail-call field wrappers (019d8…01cac; 1.2/sp2p3) |
...
| arm9   | 0x020443e8, 0x02044768, 0x020490e8–0x02049167, 0x02049444, 0x020495b4, 0x02049654, 0x0204b490–0x0204b4af, 0x0204b9f0 | lunavyqo | 2026-07-18 | done | batch16 simple accessors-4e: 16/16 MATCH (data_02091bd8 load, arg-prep tail trampolines to 49168/41840/4b7c8/495c4/49664, CP15 MMU bit, MMIO strb 0x04000247) 1.2/sp2p3 |
| arm9   | 0x02015294, 0x02017284, 0x0201a2b0, 0x0201d038, 0x0201fc04, 0x020267f4, 0x020303d4, 0x02030db8, 0x02031340, 0x02039438, 0x020394cc, 0x020394e0, 0x0203b6c0, 0x0203bb28, 0x0203c8cc, 0x02041630 | lunavyqo | 2026-07-18 | done | batch16 accessors/trampolines-5: 16/16 MATCH (global clear, tail veneer, mla index*0xc, field sub, byte init, halfword tables, stride 0x584, cond state, ptr stores, base+j*8, ush offset load) 1.2/sp2p3 |
| arm9   | 0x0204b758, 0x0204b784, 0x0204b7d4, 0x0204bf50, 0x0204c7b8, 0x0204c7cc, 0x02009584, 0x02009710, 0x0200a020, 0x0200b1f8, 0x02012814, 0x020176d8, 0x02017c34, 0x020198a0, 0x0201abb0, 0x0201f774 | lunavyqo | 2026-07-18 | done | batch16 g3 leaves: 16/16 MATCH (CPSR I/IF, halt loop, stmltia fill, arg trampolines, Vec4i copy, data_0208938c, field inits, mla index) 1.2/sp2p3 |

| arm9   | 0x02041644, 0x02041840, 0x020420e8, 0x02042814, 0x02043100, 0x020431d4, 0x020443f8, 0x02045ac4, 0x02045adc, 0x0204945c, 0x02049474, 0x020494c4, 0x020494dc, 0x0204a074, 0x0204b76c, 0x0204b798 | lunavyqo | 2026-07-18 | done | batch16 g3-leaves: 16/16 MATCH (CPSR I/IF restore, EXMEMCNT bits, trampolines, field leaves) 1.2/sp2p3 |
| arm9   | 0x02009290, 0x0200930c, 0x020095bc, 0x020099e8, 0x02009a04–0x02009a58, 0x02009a84, 0x02009aa0, 0x02009b34–0x02009b6c, 0x0200c954, 0x0200cb94, 0x0201507c | lunavyqo | 2026-07-18 | done | batch16 g3-leaves3: 16/16 MATCH dual-base 893d8/89414, 8938c, dual halfword globals, range/signum, Vec3 half pack (1.2/sp2p3) |
